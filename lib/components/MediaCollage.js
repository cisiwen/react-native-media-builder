...
export const MediaCollage = (props) => {
    ...
    return (React.createElement(View, { style: [style.rootContainer] },
        React.createElement(View, { style: [style.innerContainer] }, props.layout.items.map((a, i) => {
            return (React.createElement(CollageItem, { allItems: props.layout.items, item: a, resizer: a.resizerItem, key: i, onResizerSelected: onResizerSelected, selectedItem: selectedItem }));
        }))));
};
