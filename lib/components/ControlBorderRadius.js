    ...
    const renderPaddingSliderControl = () => {
        return (React.createElement(View, { style: [style.container] },
            ...
            React.createElement(View, { style: [style.sliderContainer] },
                React.createElement(Slider, { maximumValue: 20, minimumValue: 0, value: GlobalSetting.spacing.value, onValueChange: onValueChange }))));
    };
    const renderRadiusSliderControl = () => {
        return (React.createElement(View, { style: [style.container] },
            React.createElement(View, { style: [style.iconContainer] }),
            React.createElement(View, { style: [style.sliderContainer] },
                React.createElement(Slider, { maximumValue: 100, minimumValue: 0, value: GlobalSetting.radius.value, onValueChange: onRadiusValueChange }))));
    };
    return (React.createElement(View, { style: [style.rootContainer] },
