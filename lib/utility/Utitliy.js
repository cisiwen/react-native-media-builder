...
export const getValue = (percent, rootW = 411.4285583496094, rootH = 411.4285583496094, borderWidth = 1) => {
...
export const computeCollageResizer = (item, all) => {
    ...
    let topBottomLinks = (_a = n
        .filter((a) => Math.abs(a.style.oriTop + a.style.oriHeight - top) < 5)) === null || _a === void 0 ? void 0 : _a.map((a) => a.id);
    let topTopLinks = (_b = n
        .filter((a) => Math.abs(a.style.oriTop - top) < 5)) === null || _b === void 0 ? void 0 : _b.map((a) => a.id);
    ...
    let bottomTopLinks = (_c = n
        .filter((a) => Math.abs(a.style.oriTop - bottom) < 5)) === null || _c === void 0 ? void 0 : _c.map((a) => a.id);
    let bottomBottomLinks = (_d = n
        .filter((a) => Math.abs(a.style.oriTop + a.style.oriHeight - bottom) < 5)) === null || _d === void 0 ? void 0 : _d.map((a) => a.id);
    ...
    let leftLeftLinks = (_e = n
        .filter((a) => Math.abs(a.style.oriLeft - left) < 5)) === null || _e === void 0 ? void 0 : _e.map((a) => a.id);
    let leftRightLinks = (_f = n
        .filter((a) => Math.abs(a.style.oriLeft + a.style.oriWidth - left) < 5)) === null || _f === void 0 ? void 0 : _f.map((a) => a.id);
    ...
    let rightLeftLink = (_g = n
        .filter((a) => Math.abs(a.style.oriLeft - right) < 5)) === null || _g === void 0 ? void 0 : _g.map((a) => a.id);
    let rightRightLink = (_h = n
        .filter((a) => Math.abs(a.style.oriLeft + a.style.oriWidth - right) < 5)) === null || _h === void 0 ? void 0 : _h.map((a) => a.id);
