...
const resizerStyle = _reactNative.StyleSheet.create({
  resizeDragerStyle: {
    width: 40,
    height: 40,
    borderRadius: 40,
...
const ResizableView = props => {
  const resizerDynamicStyle = (0, _reactNativeReanimated.useAnimatedStyle)(() => {
    return {
  ...
  let minSize = 50;
  const resizeBottomHandler = (0, _reactNativeReanimated.useAnimatedGestureHandler)({
    onStart: (_ev, ctx) => {
  ...
  const resizeLeftHandler = (0, _reactNativeReanimated.useAnimatedGestureHandler)({
    onStart: (_ev, ctx) => {
  ...
  const resizeRightHandler = (0, _reactNativeReanimated.useAnimatedGestureHandler)({
    onStart: (_ev, ctx) => {
      //console.log(JSON.stringify(_ev));
      ctx.boxWidth = style.width.value;
      ctx.boxHeight = style.height.value;
  ...
  const resizeTopHandler = (0, _reactNativeReanimated.useAnimatedGestureHandler)({
    onStart: (_ev, ctx) => {
      //console.log(JSON.stringify(_ev));
      ctx.boxWidth = style.width.value;
      ctx.boxHeight = style.height.value;
  ...
  }, !props.collageItem.style.bottomEdge.value ? /*#__PURE__*/_react.default.createElement(_reactNativeGestureHandler.PanGestureHandler, {
  ...
  }))) : null, !props.collageItem.style.topEdge.value ? /*#__PURE__*/_react.default.createElement(_reactNativeGestureHandler.PanGestureHandler, {
    onGestureEvent: resizeTopHandler
  }, /*#__PURE__*/_react.default.createElement(_reactNativeReanimated.default.View, {
    style: [resizerStyle.topResizer, resizerStyle.resizeDragerStyle]
  }, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: [resizerStyle.resizeDragerKnob]
  }))) : null, !props.collageItem.style.leftEdge.value ? /*#__PURE__*/_react.default.createElement(_reactNativeGestureHandler.PanGestureHandler, {
    onGestureEvent: resizeLeftHandler
  }, /*#__PURE__*/_react.default.createElement(_reactNativeReanimated.default.View, {
    style: [resizerStyle.resizeDragerStyle, resizerStyle.leftResizer]
  }, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: [resizerStyle.resizeDragerKnob]
  }))) : null, !props.collageItem.style.rightEdge.value ? /*#__PURE__*/_react.default.createElement(_reactNativeGestureHandler.PanGestureHandler, {
